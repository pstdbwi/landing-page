...
function Certificate() {
	...
	if(isLoading){
		return <div className="relative h-full bg-white inset-x-0 min-h-[100vh]">
		<img
			src="/assets/ornament-ikrar/wakaf-kiri-atas.svg"
			width={100}
			height={100}
		...
		/>
		<img
			src="/assets/ornament-ikrar/wakaf-kanan-atas.svg"
			width={100}
			height={100}
		...
		/>
		<img
			src="/assets/ornament-ikrar/wakaf-kanan-bawah.svg"
			width={100}
			height={100}
		...
		/>
		<img
			src="/assets/ornament-ikrar/wakaf-kiri-bawah.svg"
			width={100}
			height={100}
	...
	return (
		<div className="relative h-full bg-white inset-x-0 min-h-[100vh]">
			...
			/>
			{/* <img
				src="/assets/ornament-ikrar/watermark.svg"
				width={500}
				height={500}
