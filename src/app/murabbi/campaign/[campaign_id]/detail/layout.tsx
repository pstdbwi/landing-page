...
import MurabiAuthDonation from "@/app/murabbi/_components/murabi-auth-donation";
import { MurabiQRCodeShareDialog, MurabiShareDialog } from "@/app/murabbi/_components/murabi-share-dialog";
...
const Layout = ({ children, params }: { children: React.ReactNode; params: { campaign_id: string } }) => {
  ...
  return (
    <LayoutMurabi footer="detail-page">
      ...
      {/* Dialogs */}
      <MurabiAuthDonation authModal={authModal} setAuthModal={setAuthModal} campaign={campaign} />
