...
import { MurabiHeaderSection } from "./murabi-header-section";
import LayoutMurabi from "./murabi-layout";
...
export function MurabiReportPage() {
  ...
  const handleProgramChange = useCallback(
    (option: any | null) => {
      replaceQuery({
        ...searchParams,
        special_section_id: option?.value || "",
        date_start,
        date_end,
      });
    },
    [date_end, date_start, replaceQuery, searchParams],
  );
