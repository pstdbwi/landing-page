...
import { MurabiCampaignCard } from "./murabi-campaign-card";
import { MurabiCardSkeleton } from "./murabi-card-skeleton";
...
export function MurabiCampaignSection() {
