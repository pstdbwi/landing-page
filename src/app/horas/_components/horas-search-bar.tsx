...
export function HorasSearchBar({ isOpen, isVisible, onToggle, onClose, className }: Props) {
  ...
  return (
    <div ref={wrapperRef} className={clsx("relative flex items-center w-full sm:max-w-xs", className)}>
      <button
        type="button"
        ...
        onClick={onToggle}
        className={clsx(
          "text-xs lg:text-sm flex items-center justify-center lg:justify-start gap-1 py-1.5 px-3 font-medium rounded-lg bg-fesyar-gold hover:opacity-90 tracking-wide text-fesyar-green-500 transition-all duration-200 w-full lg:w-fit",
