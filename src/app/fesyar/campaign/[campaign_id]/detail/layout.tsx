...
import FesyarAuthDonation from "@/app/fesyar/_components/fesyar-auth-donation";
import { FesyarQRCodeShareDialog, FesyarShareDialog } from "@/app/fesyar/_components/fesyar-share-dialog";
...
const Layout = ({ children, params }: { children: React.ReactNode; params: { campaign_id: string } }) => {
  ...
  return (
    <LayoutFesyar footer="detail-page">
      ...
      <FesyarAuthDonation authModal={authModal} setAuthModal={setAuthModal} campaign={campaign} />
