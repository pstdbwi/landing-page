      ...
      <section className="py-8 w-full mt-14 relative z-10 space-y-3 max-w-7xl mx-auto">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <FormField
                          ...
                          render={({ field }) => (
                            <FormItem>
                              <FormLabel className="text-white">Doa</FormLabel>
                              <FormControl>
                                <Textarea
                                  {...field}
        ...
        <Dialog open={openIkrar} onOpenChange={setOpenIkrar}>
          <DialogContent className="bg-fesyar-green-500 border-none rounded-xl w-full overflow-hidden max-w-lg">
            ...
            <Image src={"/assets/wakafein/pattern.png"} fill alt="pattern" className="absolute top-0 left-0" />
            <Image
              src="/assets/wakafein/pattern.png"
              fill
              alt="pattern"
