...
interface SharedAnonymousReceiptPageProps {
  params: {
    campaign_id: string;
    id: string;
  };
...
const SharedAnonymousReceiptPage = ({ params }: SharedAnonymousReceiptPageProps) => {
  ...
  return (
    <div className="relative h-full bg-white inset-x-0">
      ...
      <div className="flex flex-col justify-center w-full items-center py-10 gap-5 z-50 relative">
        ...
        <div>{detail?.id ? <QRCode className="p-2" value={detail?.id} size={100} /> : ""}</div>
...
export default SharedAnonymousReceiptPage;
