...
const Page = () => {
  ...
  const form = useForm<z.infer<typeof FormSchema>>({
    ...
    defaultValues: {
      ...
      wakif_province: donationAnonymous?.wakif_province || "35",
      wakif_city: donationAnonymous?.wakif_city || "35.78",
  ...
  const onSubmit = async (values: z.infer<typeof FormSchema>) => {
    try {
      const payload = {
        ...
        wakif_province: "35", // PROVINSI JAWA TIMUR
        wakif_city: "35.78", // KOTA SURABAYA
  ...
  return (
    <JatimLayout footer="detail-page">
