...
import SumutTopbar from "./sumut-topbar";
...
interface SumutLayoutProps {
  children: React.ReactNode;
  footer: "landing-page" | "detail-page";
}

const SumutLayout = ({ children, footer }: SumutLayoutProps) => {
  return (
    <div>
      ...
      <div className="z-20 relative max-w-7xl mx-auto mt-8 mb-8">{children}</div>
    </div>
  );
};

export default SumutLayout;
