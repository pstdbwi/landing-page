...
const IkhtiarCampaignCard = React.forwardRef<HTMLButtonElement, CardProps>(
  (
    {
      className,
      title,
    ...
    return (
      <Components
        ...
        ref={ref}
        onClick={() => router.push(`/campaign/${campaignId}/detail/about`)}
        {...props}
      >
...
export { IkhtiarCampaignCard, cardVariants };
