...
const IkhtiarSorting = ({ variant = "outline", options, className }: SortingProps) => {
  ...
  return (
    <DropdownMenu open={onOpen} onOpenChange={setOnOpen}>
      <DropdownMenuTrigger
        className={cn(
          "w-fit text-xs lg:text-sm flex items-center gap-1 py-1.5 px-3 font-medium rounded-lg bg-fesyar-gold hover:opacity-90 tracking-wide text-fesyar-green-500 transition-all duration-200",
          className,
        )}
      >
