...
import { IkhtiarCampaignCard } from "./ikhtiar-campaign-card";
import { IkhtiarCardSkeleton } from "./ikhtiar-card-skeleton";
...
export function IkhtiarCampaignSection() {
          ...
          <div className="flex flex-col md:flex-row items-center mt-6 justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <Label htmlFor="auto-update" className="text-xs">
                <GradientText className="text-sm">Auto Update ({isAutoRefetch ? "On" : "Off"})</GradientText>
              </Label>
              <Dialog>
                <DialogTrigger>
