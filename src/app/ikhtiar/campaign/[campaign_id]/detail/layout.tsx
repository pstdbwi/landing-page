...
import IkhtiarAuthDonation from "@/app/ikhtiar/_components/ikhtiar-auth-donation";
import LayoutIkhtiar from "@/app/ikhtiar/_components/ikhtiar-layout";
import { IkhtiarQRCodeShareDialog, IkhtiarShareDialog } from "@/app/ikhtiar/_components/ikhtiar-share-dialog";
  ...
  return (
    <LayoutIkhtiar footer="detail-page">
      ...
      <DesktopSideCard
        ...
        isDisabledDonation={isDisabledDonation}
      />
      ...
      {/* Mobile Bottom CTA */}
      <MobileBottomCta campaignType={campaign?.type} onDonate={handleDonate} isDisabled={isDisabledDonation} />

      {/* Dialogs */}
      <IkhtiarAuthDonation authModal={authModal} setAuthModal={setAuthModal} campaign={campaign} />
