        ...
        .then((response) => {
          ...
          setTimeout(() => {
            if (payment?.name === "QRIS") {
              router.push(`/ngopi/campaign/${params.campaign_id}/anonymous/${id}?type=qris`);
            } else {
              router.push(`/ngopi/campaign/${params.campaign_id}/anonymous/${id}?type=va`);
            }
          }, 800);
          setLoading(false);
          setOpenIkrar(false);
    ...
    <LayoutNgopi footer="detail-page">
      <section className="py-8 w-full mt-14 relative z-10 space-y-3 max-w-7xl mx-auto">
        <button
          ...
          onClick={() => router.push(`/ngopi/campaign/${params?.campaign_id}/detail/about`)}
        >
