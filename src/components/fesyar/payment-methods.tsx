...
import { PaymentMethods as TPaymentMethods } from "@/types/campaign";
...
const PaymentMethods = ({ selectPayment, paymentMethods }: Props) => {
  ...
  if (usesFallback && (isLoadingPayments || isLoadingCampaign)) {
    return (
      <div>
