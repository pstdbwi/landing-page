...
import { ScreenLoaderFesyar } from "../screen-loader-fesyar";
...
const AuthDialogFesyar = ({ authModal, setAuthModal, campaign }: Props) => {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      navigation.push(`/fesyar/campaign/${campaign?.id}/anonymous`);
    } catch (error) {
      console.error(error);
...
export default AuthDialogFesyar;
