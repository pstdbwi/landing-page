...
export function FesyarSearchBar({ isOpen, isVisible, onToggle, onClose }: Props) {
  ...
  return (
    <div ref={wrapperRef} className="relative flex items-center w-full max-w-xs">
      <button
        type="button"
      ...
      >
        <Search className="w-4 lg:w-5" /> Pencarian
      </button>
