...
interface EposDonationProgressProps {
  campaign: any;
  percent: number;
  donorCount: number;
  showTarget?: boolean;
...
const EposDonationProgress = ({ campaign, percent, donorCount, showTarget = true }: EposDonationProgressProps) => {
  return (
...
export default EposDonationProgress;
