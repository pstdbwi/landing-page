...
interface EposMobileBottomCtaProps {
  campaignType: string;
  onDonate: () => void;
  isDisabled: boolean;
}

const EposMobileBottomCta = ({ campaignType, onDonate, isDisabled }: EposMobileBottomCtaProps) => {
...
export default EposMobileBottomCta;
