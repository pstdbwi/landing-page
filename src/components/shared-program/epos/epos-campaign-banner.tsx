...
interface EposCampaignBannerProps {
  bannerUrl: string;
  onQrCodeClick: () => void;
  onShareClick: () => void;
}
...
const EposCampaignBanner = ({ bannerUrl, onQrCodeClick, onShareClick }: EposCampaignBannerProps) => {
...
export default EposCampaignBanner;
