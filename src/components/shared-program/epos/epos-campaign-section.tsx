...
import { EposCampaignCard } from "./epos-campaign-card";
import { EposCardSkeleton } from "./epos-card-skeleton";
...
export function EposCampaignSection() {
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center mt-6 justify-between bg-white/95 p-3 rounded-lg border gap-4 md:gap-0">
            <div className="flex items-center gap-3 w-full md:w-auto">
              ...
              <div className="min-w-0">
                ...
                <p className="text-base md:text-lg font-bold text-gray-900 truncate">Rp. {toMoney(totalDonation)}</p>
              </div>
            </div>
