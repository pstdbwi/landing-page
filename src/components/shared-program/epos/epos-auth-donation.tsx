...
import { z } from "zod";
import EposPaymentMethods from "./epos-payment-methods";
...
const EposAuthDonation = ({ authModal, setAuthModal, campaign }: Props) => {
                ...
                <>
                  <div className="flex items-center w-full gap-2">
                    <Switch
                      ...
                      type="button"
                    />
                    <FormLabel className="text-[0.65rem] text-gray-200 italic">Pilih Menu</FormLabel>
                  </div>
                  ...
                  {form.watch("reward_wanted") && (
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          <FormLabel className="text-white text-xs">Pilih Menu</FormLabel>
                          <FormControl>
                            <ReactSelectFesyar
                              name="reward_id"
...
export default EposAuthDonation;
