...
interface EposDesktopSideCardProps {
  campaign: any;
        ...
        >
          ...
          <div>
            ...
            {isCampaignLoading ? (
              ...
              <EposNazhirProfile campaign={campaign} />
            )}
            ...
            {isCampaignLoading ? (
              ...
              <EposDonationProgress campaign={campaign} percent={percent} donorCount={donorCount} showTarget={true} />
            )}
          </div>
...
export default EposDesktopSideCard;
