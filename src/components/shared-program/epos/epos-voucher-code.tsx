...
import { EposDialogUsedCode, EposDialogInvalidCode, EposDialogValidCode } from "./epos-dialog-verified";

interface Props {
  donation: IDonation;
}

const EposVoucherCode = ({ donation }: Props) => {
              ...
              <>
                <div className="flex items-center w-full gap-2 px-1">
                  <Switch
                    ...
                    type="button"
                  />
                  <Label className="text-[0.65rem] text-gray-200 italic">Pilih Menu?</Label>
                </div>
...
export default EposVoucherCode;
