...
import { ArrowRightIcon, InfinityIcon, MapPinIcon, PlayIcon, TimerIcon } from "lucide-react";
...
const NgopiCampaignCard = React.forwardRef<HTMLButtonElement, CardProps>(
  (
    {
      className,
      title,
    ...
    return (
      <Components
        ...
        ref={ref}
        onClick={() => router.push(`/ngopi/campaign/${campaignId}/detail/about`)}
        {...props}
      >
...
export { NgopiCampaignCard, cardVariants };
