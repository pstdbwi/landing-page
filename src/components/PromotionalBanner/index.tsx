...
import { useGetPromotionalBannerContent } from '@/services/content/hooks';
import { AspectRatio } from '@radix-ui/react-aspect-ratio';
import Image from 'next/image';
import { Skeleton } from '../Skeleton';
import Link from 'next/link';

export default function PromotionalBanner({ corpId, corpProgramId}: { corpId: string, corpProgramId: string }) {
    const { data: banner, isLoading, isError } = useGetPromotionalBannerContent({
			corpId,
			corpProgramId
		})
